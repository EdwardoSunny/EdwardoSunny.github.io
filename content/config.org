...
* HTML Viewing/Hosting
Be able to preview HTML files/websites for my personal website directly by hosting the files on local machine and be able to pull up on a browser. Also makes local changes to files immediately visible in the hosted website.
